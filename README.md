...
| 👥 **Team** | The whole team's work in an Azure DevOps project, read live (nothing stored): filter by sprint and 30/90/180-day window, then per person see closed, in-flight, bug share, median cycle time (created → closed) and aging items — for mentoring and evaluation reports. Rows expand to work items you can open and edit in place |
